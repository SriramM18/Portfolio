    ...
    return (
      <div className='border-b border-neutral-900 pb-20'>
        ...
        <div className="text-center tracking-tighter">
            ...
            <motion.p initial={{opacity:0,x:100}} whileInView={{opacity:1,x:0}} transition={{duration:1}} className="my-4"><a href="tel:756-938-1223">+91 7569381223</a></motion.p>
            <a href="mailto:srirammandalapu49@gmail.com" className="my-4">{CONTACT.email1}</a> <br /> <br />
            <a href="mailto:mandalapusriram18@gmail.com" className="my-4">{CONTACT.email2}</a>
        </div>
      </div>
    )
  }
